...
TITLE_VKR = TemplateSpec(
    ...
    mapping=[
        ...
        {"Field":"ЗавКафедрой",  "Method":"anchor_after_colон", "Anchor":"Заведующий выпускающей кафедрой", "Occur":1, "Transform":"Title"},
    ],
)
...
ZAD1 = TemplateSpec(
    ...
    detect=DetectSpec(
        ...
        optional=["Направление подготовки:", "Руководитель выпускной квалификационной работы:"],
        negative=[ "индивидуальное задание", "дневник", "титульный лист", "график" ],
        layout={"min_underscores": 3},
        threshold=20,                          # ← повыше
        must_all=[                              # ← эти две фразы ОБЯЗАТЕЛЬНЫ
            "на выпускную квалификационную работу",
            "Тема выпускной квалификационной работы:",
        ],
    ),
    settings={
        "маска_имени_файла": "{{Группа}}_{{ФИО}}_задание1.docx",
        "минимальная_длина_линии": 3,
        "политика_длины_значения": "underline_and_keep_line",
    },
    mapping=[
        {"Field":"Направление", "Method":"anchor_after_colon", "Anchor":"Направление подготовки", "Occur":1},
        {"Field":"Курс",        "Method":"between_words",      "Anchor":"Студенту",               "Label":"курса", "Occur":1},
        {"Field":"Группа",      "Method":"between_words",      "Anchor":"группы",                 "Label":"EOL",   "Occur":1},
        {"Field":"Форма",       "Method":"between_words",      "Anchor":"формы обучения",         "Label":"EOL",   "Occur":1},
        {"Field":"Тема",        "Method":"anchor_after_colon", "Anchor":"Тема выпускной квалификационной работы", "Occur":1},
        {"Field":"Руководитель","Method":"anchor_after_colon", "Anchor":"Руководитель выпускной квалификационной работы", "Occur":1, "Transform":"Title"},
    ],
)
...
HARAKT = TemplateSpec(
    ...
    detect=DetectSpec(
        # Жёсткий заголовок с первой страницы
        must_exact_lines=["ХАРАКТЕРИСТИКА"],

        # Ключевая фраза сразу под заголовком
        required=[
            "ХАРАКТЕРИСТИКА",
            "Настоящая характеристика дана",
        ],

        # Усиливающие (могут слегка варьироваться, но у тебя есть именно такие)
        optional=[
            "Проходившему (шей) учебную практику",
            "За время прохождения практики изучил(а):",
            "В период прохождения практики решались следующие задачи:",
            "Результат работы обучающегося",  # начало длинной строки достаточно
            "Руководитель практики от профильной организации",
        ],

        # Отсекаем чужие формы
        negative_hard=[
            "ВЫПУСКНАЯ КВАЛИФИКАЦИОННАЯ РАБОТА",
            "Антиплагиат",
            "электронно-библиотечной системе",
        ...
        negative_soft=[
            "индивидуальное задание", "задание", "дневник",
            "титульный", "график", "договор", "отчет", "отчёт",
        ],

        layout={"min_underscores": 1},
        threshold=8,  # хватает двух required (+10) для уверенного матчa
    ),
    settings={
